...
CATALOG = pd.DataFrame({
    ...
    "image_url":
    ["", "", "http://img/dune.jpg", "https://s.gr-assets.com/assets/nophoto/book/x.png"],
})
...
def test_recommend_by_history_returns_labels():
    ...
    assert out == [
        "Dune by Frank Herbert — Desert planet Arrakis…",
...
def test_similar_to_returns_labels():
    ...
    assert out == [
        "Hobbit Tales", "The Fellowship of the Ring by J.R.R. Tolkien — Frodo leaves the Shire…"
    ]
